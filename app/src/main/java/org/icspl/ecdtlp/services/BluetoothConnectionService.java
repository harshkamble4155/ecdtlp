...
//            UUID.fromString("8ce255c0-200a-11e0-ac64-0800200c9a66");
    ...
    public BluetoothConnectionService(Context context, IClickListener iClickListenerNew) {
        mContext = context;
        mBluetoothAdapter = BluetoothAdapter.getDefaultAdapter();
        iClickListener = iClickListenerNew;
        start();
    }
        ...
        public void run(){
            ...
            while (true) {
                ...
                try {
                    ...
                    iClickListener.msgSent(incomingMessage);
                } catch (IOException e) {
    ...
    private void connected(BluetoothSocket mmSocket, BluetoothDevice mmDevice) {
        ...
        //Toast.makeText(mContext, "Connected to device.", Toast.LENGTH_LONG).show();
